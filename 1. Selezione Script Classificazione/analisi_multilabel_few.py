...
examples = {
    "Incidente in via Duca Alessandro.": [1, 0, 1, 0, 0],
    "Scontro frontale in via Togliatti a Langhirano.": [1, 0, 1, 0, 0],
    "Un camion si è ribaltato sulla tangenziale ovest di Parma.": [1, 0, 1, 0, 0],
    "Due auto si sono scontrate all’incrocio tra via Roma e via Verdi.": [1, 0, 1, 0, 0],
    "Il traffico è tornato regolare dopo l’incidente.": [0, 0, 0, 0, 0],
    "Come sindaco e come rappresentante della comunità ci tengo a ricordarlo.": [0, 0, 0, 0, 0],
    "È intervenuta la polizia municipale per i rilievi.": [0, 0, 0, 0, 0],
    "Non si conoscono ancora le cause dell’impatto.": [0, 0, 0, 0, 0]
}

def analyze_incident(phrase, num_examples=2):
