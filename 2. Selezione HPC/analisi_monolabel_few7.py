...
examples = {
    "localizzazione": [
        ...
        ("Loris Catelli, investito da un'auto, è deceduto dopo l'incidente avvenuto in via Roma Nord a Vezzano, in provincia di Reggio Emilia.", 1),
        ("Sul posto la Polizia Municipale e gli operatori del 118.", 0),
        ("In via Colorno, il camion coinvolto nell'incidente.", 1),
        ("Non si conoscono al momento le cause dell'incidente.", 0),
    ],
    "tempo": [
        ...
        ("L'incidente si è verificato verso le ore 22.", 1),
        ("Auto travolta da un carico di marmo di un tir, avvenuto all' altezza del km 129.", 0),
        ("Poco prima delle ore 04.30, è stato riaperto il tratto interessato, chiuso a seguito di un incidente.", 1),
        ("Secondo le prime informazioni l'incidente non avrebbe provocato feriti gravi.", 0),
    ],
    "grave": [
        ...
        ("Il caso di una donna trans investita e uccisa da un'auto mentre si trovava a piedi lungo la tangenziale Sud.", 1),
        ("L'altro conducente non ha riportato ferite e ha rifiutato il trasporto in Ospedale.", 0),
        ("Un anziano è stato investito da un auto ed è stato trasportato d'urgenza all'Ospedale Maggiore di Parma.", 1),
        ("Nella mattinata di oggi si è verificato un incidente stradale che non ha provocato feriti gravi.", 0),
    ],
    "moto": [
        ...
        ("Un motociclista sarebbe caduto sull'asfalto dopo essersi schiantato contro un guardrail.", 1),
        ("Un pedone è stato investito da un'auto mentre si trovava lungo la carreggiata.", 0),
        ("Un'auto e una moto si sono scontrate.", 1),
        ("Due auto sono venute in collisione, provocando il ferimento di quattro persone.", 0),
    ],
    "utenti_deboli": [
        ...
        ("A Fidenza, un ciclista è stato investito da un'auto.", 1),
        ("L'auto è finita fuori strada e si è ribaltata.", 0),
        ("Il bambino non sarebbe comunque in pericolo di vita.", 1),
        ("Il tratto è stato riaperto ma fino a notte venivano segnalate code.", 0),
    ]
}
