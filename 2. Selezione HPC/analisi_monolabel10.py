...
label_prompts = {
    "localizzazione": "La frase menziona specificamente dove è avvenuto l'incidente (via, piazza, comune, frazione)?",
    "tempo": "Viene indicato quando è successo (orario, data, riferimenti temporali relativi)?\n",
    "grave": "Ci sono state conseguenze gravi per le persone coinvolte?",
    "moto": "Sono coinvolti moto, scooter, motorini o simili?",
    "utenti_deboli": "Sono coinvolti utenti deboli della strada?"
}

# ------------------------------------------------------------------------------------------

file_output = "prompt10_monolabel.csv"
