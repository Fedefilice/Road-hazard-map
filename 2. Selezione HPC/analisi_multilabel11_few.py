...
examples = {
    ...
    "Un ciclista è stato investito alle ore 6:30 in via IV Novembre.": [1,1,0,0,1],
    "Il motociclista è stato trasportato d'urgenza al pronto soccorso di Parma in condizioni gravi.": [0,0,1,1,0],
    "L'incidente è avvenuto intorno alle 20 di ieri sera.": [0,1,0,0,0],
    "Scontro nei pressi del ponte di Colorno, sulla strada provinciale 12.": [1,0,0,0,0],
    "Il camionista deceduto all'ospedale di Parma era originario della provincia di Forlì.": [0,0,0,0,0],
    "Un bambino in bicicletta è stato urtato da un’auto.": [0,0,0,0,1]
}

def analyze_incident(phrase, num_examples=8):
...
# nome file di output
file_output = "prompt_multilabel11_few.csv"
